...
public class Vanguards extends JFrame {
    ...
    private static final Color TEXT_DARK = new Color(180, 180, 190);
    ...
    enum BossArchetype {
        COLOSSUS("Colossus", new Color(200, 60, 60)), NECROMANCER("Necromancer", new Color(120, 40, 200)),
        MECHA_CORE("Mecha-Core", new Color(60, 200, 220)), VOID_DRAGON("Void Dragon", new Color(40, 10, 60));
        String name; Color color;
        BossArchetype(String n, Color c) { name = n; color = c; }
    }

    enum Rarity {
        COMMON(Color.LIGHT_GRAY, 1.0, "Common", 10), RARE(new Color(0, 150, 255), 1.8, "Rare", 25),
    ...
    class Familiar extends Item {
        ...
        public void render(Graphics2D g, int x, int y, int tick) {
            ...
            switch(id) {
                case 0: g2.setColor(new Color(0, 200, 255, 150)); g2.fillOval(-10, -10, 20, 20); g2.setColor(Color.WHITE); g2.fillOval(-4, -4, 8, 8); break;
                case 1: g2.setColor(Color.GREEN); g2.fillPolygon(new int[]{0, 8, 0, -8}, new int[]{-10, 0, 10, 0}, 4); g2.setColor(new Color(200, 255, 200, 150)); g2.fillOval(-15, -5, 10, 10); g2.fillOval(5, -5, 10, 10); break;
                case 2: g2.setColor(new Color(0, 255, 100, 180)); g2.fillArc(-12, -10, 24, 20, 0, 180); g2.setColor(Color.BLACK); g2.fillOval(-6, -5, 3, 3); g2.fillOval(3, -5, 3, 3); break;
                case 3: g2.setColor(Color.RED); g2.fillPolygon(new int[]{0, 10, -10}, new int[]{-10, 10, 10}, 3); g2.setColor(Color.DARK_GRAY); g2.drawArc(-10, -15, 8, 8, 0, 180); g2.drawArc(2, -15, 8, 8, 0, 180); break;
                case 4: g2.setColor(Color.PINK); g2.fillOval(-6, -6, 12, 12); int wing = (int)(Math.sin(tick*0.5)*8); g2.setColor(new Color(255, 255, 0, 150)); g2.fillOval(-15, -wing, 10, wing*2+2); g2.fillOval(5, -wing, 10, wing*2+2); break;
                case 5: g2.setColor(Color.DARK_GRAY); g2.fillOval(-5, -5, 10, 10); int flap = (int)(Math.sin(tick*0.4)*10); g2.fillPolygon(new int[]{-5, -15, -5}, new int[]{0, -flap, 5}, 3); g2.fillPolygon(new int[]{5, 15, 5}, new int[]{0, -flap, 5}, 3); break;
                case 6: g2.setColor(Color.MAGENTA); g2.fillPolygon(new int[]{0, 5, 0, -5}, new int[]{-8, 0, 8, 0}, 4); g2.setColor(new Color(255, 255, 255, 100)); g2.drawOval(-12, -12, 24, 24); break;
                case 7: g2.setColor(Color.GRAY); g2.fillRect(-10, -5, 20, 10); g2.fillPolygon(new int[]{5, 12, 10}, new int[]{-5, -5, 0}, 3); g2.setColor(Color.LIGHT_GRAY); g2.drawLine(-10, 0, -15, 5); break;
                case 8: g2.setColor(Color.BLACK); g2.fillOval(-12, -6, 24, 12); g2.setColor(Color.YELLOW); g2.fillOval(5, -4, 3, 3); break;
                case 9: g2.setColor(new Color(200, 50, 50)); g2.fillRoundRect(-10, -8, 20, 16, 5, 5); g2.setColor(Color.ORANGE); g2.fillPolygon(new int[]{0, -10, 10}, new int[]{-8, -15, -15}, 3); break;
                case 10: g2.setColor(new Color(139, 69, 19)); g2.fillRect(-8, -10, 16, 20); g2.setColor(new Color(100, 50, 10)); g2.fillRect(-12, -5, 4, 10); g2.fillRect(8, -5, 4, 10); break;
                case 11: g2.setColor(Color.GRAY); g2.fillPolygon(new int[]{0, 10, -10}, new int[]{-10, 10, 10}, 3); g2.setColor(Color.DARK_GRAY); g2.fillOval(-12, -5, 8, 10); g2.fillOval(4, -5, 8, 10); break;
                case 12: g2.setColor(new Color(210, 180, 140)); g2.fillOval(-10, -6, 20, 12); g2.setColor(Color.RED); g2.fillOval(5, -10, 10, 10); g2.setColor(Color.BLACK); g2.drawArc(-15, -10, 10, 10, 90, 180); break;
                case 13: g2.setColor(new Color(101, 67, 33)); g2.fillRect(-4, -5, 8, 15); g2.setColor(new Color(34, 139, 34)); g2.fillOval(-10, -15, 20, 20); break;
                case 14: g2.setColor(Color.WHITE); g2.fillArc(-12, -8, 16, 16, 90, 180); g2.setColor(new Color(255, 215, 0)); g2.fillArc(-4, -8, 16, 16, -90, 180); g2.setColor(Color.LIGHT_GRAY); g2.fillPolygon(new int[]{0, -10, 10}, new int[]{-8, -15, -15}, 3); break;
                case 15: g2.setColor(Color.RED); g2.fillPolygon(new int[]{0, 15, -15}, new int[]{10, -10, -10}, 3); g2.setColor(Color.ORANGE); g2.fillOval(-6, -6, 12, 12); g2.setColor(Color.YELLOW); g2.drawLine(0, 10, 0, 20); break;
                case 16: g2.setColor(new Color(70, 0, 70)); g2.fillRect(-15, -15, 30, 30); g2.setColor(Color.RED); g2.fillRect(5, -5, 5, 5); g2.fillRect(-10, -5, 5, 5); break;
                case 17: g2.setColor(new Color(0, 150, 100)); for(int i=0; i<5; i++) { int wy = (int)(Math.sin(tick*0.2 + i)*5); g2.fillOval(-15 + i*6, wy - 5, 10, 10); } break;
                case 18: g2.setColor(Color.BLUE); g2.fillArc(-15, -10, 30, 20, 0, 180); g2.fillPolygon(new int[]{-15, -25, -25}, new int[]{0, -5, 5}, 3); g2.setColor(Color.CYAN); g2.fillOval(5, -5, 4, 4); break;
                case 19: g2.setColor(new Color(210, 180, 140)); g2.fillOval(-12, -8, 24, 16); g2.setColor(Color.RED); g2.fillOval(4, -12, 8, 8); g2.setColor(Color.GRAY); g2.fillOval(-4, -14, 8, 8); g2.setColor(Color.GREEN); g2.fillOval(-12, -10, 8, 8); break;
            }
            g2.dispose();
        }
    }
    ...
    abstract class Equipment extends Item {
        ...
        public Equipment(String n, int p, int h, int a, int d, int s, int l, int st, int co, int de, int in, int wi, int ch, Rarity r) {
            super(n, p, r); hp = h; atk = a; def = d; spd = s; luk = l; str = st; con = co; dex = de; intelligence = in; wis = wi; cha = ch;
        }
    ...
    abstract class Entity {
        ...
        public Entity(String n, int h, int a, int d, int s, int l, Color c) {
            name = n; maxHp = h; hp = h; atk = a; def = d; spd = s; luk = l; color = c; displayHp = hp;
            this.str = a; this.con = h / 10; this.dex = s; this.intelligence = a; this.agi = s; this.crt = l / 2; this.eva = s / 2;
        }

        public void takeDamage(int dmg) {
            if(vulnTurns > 0) dmg = (int)(dmg * 1.5);
            if(shield > 0) {
                if(dmg <= shield) { shield -= dmg; dmg = 0; } else { dmg -= shield; shield = 0; }
            }
    ...
    class Player extends Entity {
        ...
        public String getRankTitle() {
            if(level < 5) return "Novice"; if(level < 10) return "Adept"; if(level < 15) return "Expert";
            if(level < 20) return "Master"; if(level < 25) return "Grandmaster"; return "Vanguard";
        }
        ...
        @Override public void updateLiveStats() {
            super.updateLiveStats(); totalRunTicks++; displayEnergy += (energy - displayEnergy) * 0.15; displayXp += (xp - displayXp) * 0.15;
            if(combo > maxComboAchieved) maxComboAchieved = combo; updateAnimation(1);
        }
        ...
        public void render(Graphics2D g, int x, int y, int tick) {
            ...
            if(currentAnim.equals("CAMP")) {
                ...
                g.setColor(Color.RED); g.fillPolygon(new int[]{px+55, px+65, px+45}, new int[]{py+85, py+70, py+70}, 3);
                g.setColor(new Color(139, 69, 19)); g.fillRect(px+45, py+80, 30, 8);
                if(tick % 5 == 0) particles.add(new Particle(Color.ORANGE, true, px+60, py+70, (Math.random()-0.5)*2, -2 - Math.random()*3, 20, 3));
            }

            if(winStreak >= 3 || combo > 0) {
                int intensity = Math.min(10, winStreak + combo); g.setColor(new Color(cls.color.getRed(), cls.color.getGreen(), cls.color.getBlue(), 40 + intensity * 10));
                for(int i = 0; i < 5 + intensity; i++) {
                    int fx = px - 25 + (int)(Math.random() * 80); int fy = py + 90 - (int)(Math.random() * 120); g.fillOval(fx, fy, 10 + (int)(Math.random()*20), 10 + (int)(Math.random()*20));
                }
            }

            g.setColor(new Color(0,0,0,100)); g.fillOval(px-15, y+85, 90, 20); g.setColor(hitFlash > 0 ? Color.WHITE : color);
            if(shield > 0) { g.setColor(new Color(100, 200, 255, 100)); g.fillOval(px-20, py-10, 100, 110); g.setColor(hitFlash > 0 ? Color.WHITE : color); }

            if(cls == ClassType.KNIGHT) {
                g.setColor(Color.LIGHT_GRAY); g.fillRoundRect(px-10, py+10, 30, 80, 5, 5); g.setColor(hitFlash > 0 ? Color.WHITE : color); g.fillRoundRect(px, py, 60, 85, 15, 15);
                g.setColor(new Color(50, 40, 60)); g.fillOval(px-20, py+30, 40, 50); g.setColor(new Color(212, 175, 55)); g.fillRect(px+50, py+35, 20, 5); g.setColor(Color.WHITE);
                g.fillRect(px-15, py+50, 20, 5); g.fillRect(px-7, py+40, 5, 25); g.setColor(Color.DARK_GRAY); g.fillRect(px+10, py+15, 40, 5);
            } else if(cls == ClassType.SORCERER) {
                g.fillPolygon(new int[]{px+30, px-15, px+75}, new int[]{py, py+85, py+85}, 3); g.setColor(new Color(0, 255, 255)); g.fillOval(px+58, py-25, 20, 20); g.fillOval(px+10, py-30, 15, 15);
                g.setColor(new Color(139, 69, 19)); g.fillRect(px+65, py-15, 5, 90); g.setColor(new Color(80, 20, 100)); g.fillPolygon(new int[]{px+10, px-20, px+40}, new int[]{py+20, py+90, py+90}, 3);
                g.setColor(Color.BLUE); g.fillRect(px-10, py+40, 15, 20); g.setColor(Color.WHITE); g.drawLine(px-5, py+45, px+2, py+45);
            } else if(cls == ClassType.RANGER) {
                g.setColor(new Color(20, 50, 20)); g.fillPolygon(new int[]{px-10, px+30, px+70}, new int[]{py+90, py+10, py+90}, 3); g.setColor(hitFlash > 0 ? Color.WHITE : color);
                g.fillPolygon(new int[]{px, px+20, px+40}, new int[]{py+80, py, py+80}, 3); g.setColor(Color.GREEN); g.fillOval(px+15, py+30, 10, 10); g.setColor(Color.WHITE); g.drawLine(px+10, py+10, px+10, py+70);
                g.setColor(Color.LIGHT_GRAY); g.drawLine(px+10, py+40, px+30, py+40); g.setColor(Color.BLACK); g.fillOval(px+15, py+15, 10, 10);
            } else if(cls == ClassType.PALADIN) {
                g.setColor(new Color(255, 215, 0, 100)); g.fillOval(px-10, py-10, 70, 70); g.setColor(hitFlash > 0 ? Color.WHITE : color); g.fillRect(px, py, 50, 85); g.setColor(Color.YELLOW); g.fillRect(px+20, py+10, 10, 50);
                g.fillRect(px+10, py+30, 30, 10); g.setColor(Color.WHITE); g.fillRect(px+20, py+35, 10, 30); g.fillRect(px+10, py+45, 30, 10); g.setColor(Color.YELLOW); g.drawOval(px+5, py-15, 40, 15);
            } else if(cls == ClassType.RONIN) {
                g.fillRoundRect(px+5, py+15, 40, 70, 5, 5); g.setColor(Color.DARK_GRAY); g.fillOval(px-5, py, 60, 20); g.setColor(Color.LIGHT_GRAY); g.fillRect(px+45, py+40, 40, 5); g.setColor(Color.LIGHT_GRAY); g.drawLine(px+65, py+42, px+95, py+42);
                g.setColor(Color.RED); g.fillRect(px, py+10, 50, 5); g.fillPolygon(new int[]{px, px-15, px-10}, new int[]{py+10, py+20, py+30}, 3);
            } else if(cls == ClassType.BARD) {
                g.fillRoundRect(px-5, py+10, 40, 75, 10, 10); g.setColor(new Color(139, 69, 19)); g.fillOval(px+5, py+35, 30, 40); g.fillRect(px+15, py+15, 10, 30); g.setColor(Color.MAGENTA);
                g.fillPolygon(new int[]{px-10, px+20, px+40}, new int[]{py+10, py-10, py+10}, 3); g.setColor(Color.YELLOW); g.fillOval(px+35, py-15, 8, 15);
            } else if(cls == ClassType.DRUID) {
                g.fillRoundRect(px, py+5, 45, 80, 5, 5); g.setColor(new Color(101, 67, 33)); g.drawLine(px+10, py+5, px-5, py-15); g.drawLine(px-5, py-15, px-15, py-10); g.drawLine(px+35, py+5, px+50, py-15); g.drawLine(px+50, py-15, px+60, py-10);
                g.setColor(new Color(34, 139, 34)); g.fillOval(px-5, py+30, 60, 10); g.fillOval(px+15, py+50, 60, 10);
            } else if(cls == ClassType.NECROMANCER) {
                g.fillPolygon(new int[]{px+20, px-10, px+50}, new int[]{py, py+85, py+85}, 3); g.setColor(Color.WHITE); g.fillOval(px+10, py-10, 20, 25); g.setColor(Color.BLACK); g.fillOval(px+13, py-3, 5, 5); g.fillOval(px+22, py-3, 5, 5); g.setColor(Color.GRAY);
                g.fillRect(px+40, py, 5, 90); g.fillArc(px+20, py-10, 30, 30, 45, 180);
            } else if(cls == ClassType.ALCHEMIST) {
                g.fillRoundRect(px+5, py+10, 35, 75, 8, 8); g.setColor(Color.CYAN); g.fillOval(px+5, py, 15, 15); g.fillOval(px+25, py, 15, 15); g.setColor(Color.BLACK); g.drawLine(px+20, py+7, px+25, py+7); g.setColor(Color.GREEN);
                g.fillPolygon(new int[]{px-10, px-20, px}, new int[]{py+40, py+60, py+60}, 3); g.setColor(Color.WHITE); g.fillRect(px-12, py+35, 4, 5);
            } else {
                g.fillRoundRect(px+10, py, 40, 85, 20, 20); g.setColor(Color.CYAN); g.fillRect(px+15, py+20, 30, 8); g.setColor(Color.DARK_GRAY); g.fillArc(px+5, py-5, 50, 45, 0, 180); g.setColor(Color.GREEN); g.fillOval(px+15, py+15, 12, 12);
                g.fillOval(px+30, py+15, 12, 12); g.setColor(new Color(100, 80, 50)); g.fillRoundRect(px-10, py+20, 15, 40, 5, 5); g.setColor(Color.DARK_GRAY); g.fillRect(px+45, py+30, 40, 10); g.fillRect(px+55, py+40, 10, 15);
            }

            if(hasPet) {
                g.setColor(Color.CYAN); int petX = px - 40 + (int)(Math.sin(tick*0.1)*10); int petY = py + 20 + (int)(Math.cos(tick*0.15)*10); g.fillOval(petX, petY, 15, 15);
            }

            for(int i=0; i<equippedFamiliars.size(); i++) {
                Familiar f = equippedFamiliars.get(i);
                int fx = px + (i == 0 ? -50 : 60) + (int)(Math.sin(tick*0.05 + f.id)*10); int fy = py + (i == 0 ? 10 : 30) + (int)(Math.cos(tick*0.07 + f.id)*10);
                f.render(g, fx, fy, tick);
            }

            g.setFont(FONT_SANSSERIF_BOLD_12); g.setColor(Color.WHITE);
            int nameWidth = g.getFontMetrics().stringWidth(name); g.drawString(name, px + (30 - nameWidth/2), py - 50);

            g.setColor(Color.LIGHT_GRAY); String rank = "<" + getRankTitle() + ">"; int rankWidth = g.getFontMetrics().stringWidth(rank);
    ...
    class Enemy extends Entity {
        boolean isBoss; int turnCounter = 0; EnemyType archetype; EliteModifier elite = EliteModifier.NONE; BossArchetype bossArchetype;
        public Enemy(String n, int stage, boolean boss) {
            ...
            if(boss) {
                BossArchetype[] bTypes = BossArchetype.values(); this.bossArchetype = bTypes[new Random().nextInt(bTypes.length)];
                this.color = bossArchetype.color; this.name = "OVERLORD: " + bossArchetype.name;
            } else {
                EnemyType[] types = EnemyType.values(); this.archetype = types[new Random().nextInt(types.length)];
            ...
            this.maxHp = this.hp = baseHP; this.atk = baseATK; this.def = baseDEF; this.spd = baseSPD; this.luk = 2; this.displayHp = this.hp;
        }

        @Override public void updateLiveStats() { super.updateLiveStats(); updateAnimation(-1); }

        public void render(Graphics2D g, int x, int y, int tick) {
            int px = x + animX; double hover = Math.sin(tick * 0.08) * 10; int py = y + (isBoss ? -60 : 20) + (int)hover + animY;
            if(currentAnim.equals("WINDUP")) {
                g.setColor(new Color(255, 50, 50, 100)); int auraSize = 100 + (animTick * 2); g.fillOval(px - auraSize/2 + 50, py - auraSize/2 + 50, auraSize, auraSize);
            }
            ...
            if (isBoss) {
                if(bossArchetype == BossArchetype.COLOSSUS) { g.fillRect(px, py, 140, 140); g.setColor(Color.RED); g.fillOval(px+40, py+40, 20, 20); g.fillOval(px+80, py+40, 20, 20); }
                else if(bossArchetype == BossArchetype.NECROMANCER) { g.fillPolygon(new int[]{px+70, px+140, px}, new int[]{py-40, py+140, py+140}, 3); g.setColor(Color.MAGENTA); g.fillOval(px-20, py+(int)(Math.sin(tick*0.1)*10), 30, 30); g.fillOval(px+130, py+(int)(Math.cos(tick*0.1)*10), 30, 30); }
                else if(bossArchetype == BossArchetype.MECHA_CORE) { g.fillOval(px+10, py+10, 120, 120); g.setColor(Color.CYAN); g.drawArc(px-10, py-10, 160, 160, tick*5, 180); g.drawArc(px, py, 140, 140, -tick*5, 180); g.fillOval(px+50, py+50, 40, 40); }
                else if(bossArchetype == BossArchetype.VOID_DRAGON) { int[] dx = {px+10, px+70, px+130, px+150, px+90, px-20}; int[] dy = {py+40, py-20, py+60, py+140, py+100, py+120}; g.fillPolygon(dx, dy, 6); g.setColor(Color.YELLOW); g.fillOval(px+50, py+10, 15, 15); }
            } else {
                ...
                g.setColor(Color.BLACK); g.fillOval(px+20, py+20, 30, 30); g.setColor(Color.RED); g.fillOval(px+30, py+30, 10, 10);
            }
    ...
    class Particle {
        double x, y, speedX, speedY, size; Color c; int life = 100; boolean temporary = false;
        public Particle(Color c, boolean temp, double startX, double startY) {
            ...
            if(!temp) { this.speedY = 0.5 + Math.random() * 2; this.speedX = 0; this.x = Math.random() * 1350; this.y = Math.random() * 480; }
        ...
        public Particle(Color c, boolean temp, double startX, double startY, double vx, double vy, int life, double size) {
            this.c = c; this.temporary = temp; this.x = startX; this.y = startY; this.speedX = vx; this.speedY = vy; this.life = life; this.size = size;
        }
        public boolean update() { if (temporary) { y -= speedY; x += speedX; life--; return life <= 0; } y -= speedY; x += speedX; if(y < 0) { y = 480; x = Math.random() * 1350; } return false; }
        public void draw(Graphics2D g) { int alpha = temporary ? Math.max(0, Math.min(255, life * 5)) : 60; g.setColor(new Color(c.getRed(), c.getGreen(), c.getBlue(), alpha)); g.fillOval((int)x, (int)y, (int)size, (int)size); }
    }

    class DamageNumber {
        int val, x, y, life=40; Color c; String text = null;
        public DamageNumber(int v, int x, int y, Color c) { val=v; this.x=x + (int)(Math.random() * 40 - 20); this.y=y + (int)(Math.random() * 20 - 10); this.c=c; }
        ...
        public void draw(Graphics2D g) {
            ...
            g.setFont(FONT_IMPACT_28); g.setColor(new Color(0,0,0, Math.max(0, life*5)));
            g.drawString(display, x-1, y-1); g.drawString(display, x+1, y-1); g.drawString(display, x-1, y+1); g.drawString(display, x+1, y+1);
            g.setColor(new Color(c.getRed(), c.getGreen(), c.getBlue(), Math.max(0, life*6))); g.drawString(display, x, y);
        }
    }

    class IntroScreen extends JPanel {
        private ClassType cls; private int tick = 0; private Timer animTimer;
        ...
        public void play(ClassType ct, Runnable onComplete) {
            ...
            animTimer = new Timer(30, e -> { tick++; repaint(); if(tick > 80) { animTimer.stop(); onComplete.run(); } }); animTimer.start();
        }
        @Override protected void paintComponent(Graphics g) {
            super.paintComponent(g); if(cls == null) return; Graphics2D g2 = (Graphics2D)g; g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setColor(new Color(cls.color.getRed(), cls.color.getGreen(), cls.color.getBlue(), Math.min(255, tick * 3))); g2.fillRect(0, 0, getWidth(), getHeight());
            g2.setColor(Color.WHITE); g2.setFont(new Font("Serif", Font.BOLD, 80)); FontMetrics fm = g2.getFontMetrics();
            String t = cls.title.toUpperCase(); g2.drawString(t, (getWidth() - fm.stringWidth(t))/2, getHeight()/2);
        }
    }
    ...
    class BossWarningScreen extends JPanel {
        ...
        public void play(Runnable onComplete) {
            ...
            animTimer = new Timer(30, e -> { tick++; repaint(); if(tick > 90) { animTimer.stop(); onComplete.run(); } }); animTimer.start();
        }
        @Override protected void paintComponent(Graphics g) {
            ...
            int fade = Math.min(255, tick * 5); g2.setColor(new Color(fade / 2, 0, 0)); g2.fillRect(0, 0, getWidth(), getHeight());
            if(tick % 10 < 5) { g2.setColor(Color.RED); g2.setFont(FONT_IMPACT_30_ITALIC.deriveFont(100f)); FontMetrics fm = g2.getFontMetrics(); g2.drawString("WARNING: OVERLORD APPROACHES", (getWidth() - fm.stringWidth("WARNING: OVERLORD APPROACHES"))/2, getHeight()/2); }
        }
    }

    class TutorialScreen extends JPanel {
        public TutorialScreen() {
            setLayout(new BorderLayout()); setBackground(PANEL_BG); setBorder(new EmptyBorder(50, 100, 50, 100));
            JLabel title = new JLabel("HOW TO PLAY", SwingConstants.CENTER); title.setFont(new Font("Serif", Font.BOLD, 60)); title.setForeground(ACCENT_COL); add(title, BorderLayout.NORTH);
            String tutorialHtml = "<html><body style='width: 760px; color: #F5F5F5; font-family: SansSerif; font-size: 16px; text-align: left;'>"
                    + "<div align='left'><h2><font color='#D4AF37'>COMBAT SYSTEM</font></h2>Spend Energy to use class abilities. String attacks together to build Combos for massive damage multipliers.<br><br></div>"
                    + "<table width='100%' cellpadding='10'><tr><td width='50%' valign='top' bgcolor='#2a2a35'><div align='left'><h3><font color='#D4AF37'>PRIMARY STATS</font></h3></div><ul>"
                    + "<li><b>ATK:</b> Increases damage dealt.</li><li><b>DEF:</b> Reduces damage taken.</li><li><b>SPD:</b> Increases Evasion & Parry chances.</li><li><b>LUK:</b> Increases Critical Hit chance.</li></ul></td>"
                    ...
                    + "<div align='left' bgcolor='#2a2a35' style='padding: 10px;'><h2><font color='#D4AF37'>SHOP & BOUNTIES</font></h2>Slay enemies to earn Gold and complete Bounties. Use Gold in the Shop to buy gear, potions, and upgrades. The Shop refreshes every 3 battles.<br><br>"
    ...
    class BattlePanel extends JPanel {
        private Enemy enemy; private int tick = 0; public JTextArea log;
        private CardLayout menuCards = new CardLayout(); private JPanel menuPanel = new JPanel(menuCards);
        ...
        private int lastInventoryTab = 0; private int scrollWeapon = 0, scrollArmor = 0, scrollRelic = 0, scrollConsumable = 0;
        private String currentMenuKey = "MAIN"; private int mysteryBoxPity = 0; private int totalShopRefreshes = 0;

        // Prayer variables
        private int prayerCooldown = 0; private boolean prayerActive = false; private int godAnimY = -200;
        ...
        public BattlePanel() {
            ...
            // New UI Button Layer for Speed Toggle
            renderArea.setLayout(null);
            StylizedButton speedBtn = new StylizedButton("▶ SPEED: 1X");
            speedBtn.setBounds(810, 10, 130, 40);
            speedBtn.setFocusable(false); // Prevents stealing hotkeys
            ...
            log = new JTextArea(); log.setBackground(new Color(15, 15, 22)); log.setForeground(TEXT_LIGHT); log.setFont(new Font("Monospaced", Font.PLAIN, 14)); log.setEditable(false); log.setMargin(new Insets(10, 10, 10, 10));
            ...
            gameLoop = new Timer(30, e -> {
                ...
                if (prayerActive) {
                    ...
                    else if (prayerPhase.equals("ASCEND")) { godAnimY -= 8; if (godAnimY < -200) { prayerActive = false; prayerCooldown = 5; if (state.player.hp > 0) { endPlayerTurn(); } } }
                    repaint(); return;
                }

                tick++; updateDmg(); if(screenShake > 0) screenShake--; particles.removeIf(Particle::update);
                if(state.player != null) state.player.updateLiveStats(); if(enemy != null) enemy.updateLiveStats();
                log.setCaretPosition(log.getDocument().getLength()); repaint();
            });

            bindHotkey("1", () -> attemptHotkeyAttack(0)); bindHotkey("2", () -> attemptHotkeyAttack(1)); bindHotkey("3", () -> attemptHotkeyAttack(2)); bindHotkey("4", () -> attemptHotkeyAttack(3));
            bindHotkey("Q", () -> { if(!inputLocked && state.player.healPots > 0 && state.player.hp < state.player.getTotalMaxHp()) consumePotion("Minor"); });
            bindHotkey("W", () -> { if(!inputLocked && state.player.greaterPots > 0 && state.player.hp < state.player.getTotalMaxHp()) consumePotion("Greater"); });
            bindHotkey("E", () -> { if(!inputLocked && state.player.dmgBuffs > 0) consumePotion("Buff"); });
            bindHotkey("I", () -> { if(!inputLocked) setMenu("EQUIPMENT_DASH"); });
            bindHotkey("T", () -> toggleSpeed(speedBtn));
        }
        ...
        private void bindHotkey(String key, Runnable action) { getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(key), key); getActionMap().put(key, new AbstractAction() { public void actionPerformed(ActionEvent e) { action.run(); } }); }
        private void attemptHotkeyAttack(int index) { if(inputLocked || state.player == null) return; List<String> moves = getPlayerMoves(state.player); if(index < moves.size()) { executeAttack(moves.get(index)); } }

        private void consumePotion(String type) {
            if(type.equals("Minor")) { state.player.heal(150); state.player.healPots--; log.append("[COMBAT] Healed 150 HP\n"); dmgNums.add(new DamageNumber(150, 280, 280, Color.GREEN)); endPlayerTurn(); }
            ...
            if(type.equals("Buff")) { state.player.activeBuffTurns += 3; state.player.dmgBuffs--; log.append("[COMBAT] DMG Buff applied for 3 turns!\n"); endPlayerTurn(); }
            if(currentMenuKey.equals("MAIN") || currentMenuKey.equals("EQUIPMENT_DASH")) setMenu(currentMenuKey);
        }

        public void initSession() {
            state.encounters = 1; state.bountyKills = 0; state.bountyTarget = 3; state.bountyReward = 100;
            maxComboAchieved = 0; inputLocked = false; rerollCost = 50; mysteryBoxPity = 0; totalShopRefreshes = 0;
            prayerCooldown = 0; prayerActive = false; state.player.totalRunTicks = 0;
            setupMenus(); spawnEnemy(); refreshShop(); log.setText("[SYS] THE RIFT AWAKENS\n");
            sideShopPanel.setBorder(BorderFactory.createMatteBorder(0, 4, 0, 0, state.player.cls.color)); updateWindowTitle(); gameLoop.start();
        }

        private void updateWindowTitle() { JFrame topFrame = (JFrame) SwingUtilities.getWindowAncestor(this); if(topFrame != null) topFrame.setTitle("Vanguards | Depth: " + state.encounters + " | Level: " + state.player.level); }

        private void setupMenus() {
            menuPanel.removeAll(); subMenus.clear(); JPanel mainWrapper = new JPanel(new BorderLayout()); mainWrapper.setOpaque(false);
        ...
        private JPanel createMainActions() {
            JPanel p = new JPanel(new BorderLayout()); p.setOpaque(false); JPanel grid = new JPanel(new GridLayout(2, 4, 15, 15)); grid.setBorder(new EmptyBorder(20, 30, 10, 30)); grid.setOpaque(false);
            ...
            for(String s : btns) {
                ...
                if (s.startsWith("CAMP")) { if(state.player.gold < 10) b.setForeground(Color.DARK_GRAY); else if(state.player.hp == state.player.getTotalMaxHp() && state.player.energy == state.player.maxEnergy) { b.setForeground(Color.DARK_GRAY); b.setToolTipText("HP and Energy are already full."); } }
                ...
                b.addActionListener(e -> {
                    ...
                    else if(keyAction.startsWith("FLEE")) executeFlee(); else if(keyAction.equals("PRAYER")) { if(prayerCooldown <= 0) startPrayer(); }
                    else if(keyAction.equals("FAMILIARS")) { if(!state.player.ownedFamiliars.isEmpty()) setMenu("FAMILIARS"); else log.append("[SYS] Familiars tab locked! Buy one from the shop first.\n"); }
            ...
            StylizedButton quitBtn = new StylizedButton("QUIT TO MENU"); quitBtn.setPreferredSize(new Dimension(140, 45)); quitBtn.setFont(FONT_SANSSERIF_BOLD_12); quitBtn.setForeground(new Color(255, 80, 80));
            quitBtn.addActionListener(e -> { if(!inputLocked) { gameLoop.stop(); cards.show(mainContainer, "TITLE"); } });
            quickBar.add(quitBtn); p.add(grid, BorderLayout.CENTER); p.add(quickBar, BorderLayout.SOUTH); return p;
        }
        ...
        private List<String> getPlayerMoves(Player player) {
            ...
            else if(player.cls == ClassType.OPERATOR) ultName = "Orbital Strike"; else if(player.cls == ClassType.RANGER) ultName = "Thousand Arrows";
            else if(player.cls == ClassType.PALADIN) ultName = "Heaven's Wrath"; else if(player.cls == ClassType.RONIN) ultName = "Oblivion Slash";
            else if(player.cls == ClassType.BARD) ultName = "Symphony of Destruction"; else if(player.cls == ClassType.DRUID) ultName = "Nature's Fury";
            else if(player.cls == ClassType.NECROMANCER) ultName = "Army of the Dead"; else if(player.cls == ClassType.ALCHEMIST) ultName = "Philosopher's Detonation";
            moves.add("[ULTIMATE] " + ultName + " (100 EN)"); return moves;
        }

        private JPanel createFamiliarCard(Familiar f, Player p) {
            JPanel c = new JPanel(new BorderLayout()); c.setBorder(BorderFactory.createLineBorder(f.rarity.col, 2)); c.setBackground(new Color(25,25,30));
            boolean isEq = p.equippedFamiliars.contains(f);
            JLabel n = new JLabel("<html>" + (isEq?"<b>[E]</b> ":"") + f.name + " (" + f.size + ")</html>"); n.setForeground(f.rarity.col); n.setFont(FONT_SANSSERIF_BOLD_12); n.setBorder(new EmptyBorder(5, 5, 0, 5));
            ...
            s.setForeground(new Color(170, 170, 170)); s.setFont(FONT_SANSSERIF_PLAIN_10); s.setBorder(new EmptyBorder(5, 5, 5, 5));
            JPanel bp = new JPanel(new GridLayout(2, 2, 2, 2)); bp.setOpaque(false);
            JButton eb = new JButton(isEq ? "UNEQUIP" : "EQUIP"); eb.setFont(FONT_SANSSERIF_PLAIN_10);
            eb.addActionListener(e -> { if(isEq) p.equippedFamiliars.remove(f); else { if(p.equippedFamiliars.size() < 2) p.equippedFamiliars.add(f); else log.append("[SYS] Max 2 Familiars equipped!\n"); } setMenu("FAMILIARS"); });
            JButton syncB = new JButton("SYNC (1000G)"); syncB.setFont(FONT_SANSSERIF_PLAIN_10); if(f.isSynced) syncB.setEnabled(false);
            syncB.addActionListener(e -> { if(p.gold >= 1000) { p.gold -= 1000; f.isSynced = true; log.append("[SYS] Synced " + f.name + " for 1000G!\n"); setMenu("FAMILIARS"); } else { log.append("[SYS] Not enough gold to Sync!\n"); } });
            JButton relB = new JButton("RELEASE"); relB.setFont(FONT_SANSSERIF_PLAIN_10); if(isEq) relB.setEnabled(false);
            relB.addActionListener(e -> { p.ownedFamiliars.remove(f); log.append("[SYS] Released " + f.name + " back to the wild.\n"); setMenu("FAMILIARS"); });
            bp.add(eb); bp.add(syncB); bp.add(new JLabel()); bp.add(relB); c.add(n, BorderLayout.NORTH); c.add(s, BorderLayout.CENTER); c.add(bp, BorderLayout.SOUTH); return c;
        }

        private void refreshSubMenu(String key) {
            JPanel p = subMenus.get(key); if(p == null) return;
            ...
            if(key.equals("ATTACKS")) {
                List<String> moves = getPlayerMoves(player); int idx = 1;
                for(String m : moves) {
                    StylizedButton b = new StylizedButton("[" + idx + "] " + m); b.setPreferredSize(new Dimension(240, 50));
                ...
                StylizedButton sellAll = new StylizedButton("Sell Un-equipped"); sellAll.setFont(FONT_SANSSERIF_PLAIN_10);
                ...
                JPanel wPan = new JPanel(new GridLayout(0, 2, 10, 10)); wPan.setBackground(PANEL_BG); JPanel aPan = new JPanel(new GridLayout(0, 2, 10, 10)); aPan.setBackground(PANEL_BG);
                JPanel rPan = new JPanel(new GridLayout(0, 2, 10, 10)); rPan.setBackground(PANEL_BG); JPanel cPan = new JPanel(new GridLayout(0, 2, 10, 10)); cPan.setBackground(PANEL_BG);
                ...
                for(Item it : sortedInv) {
                    if(it instanceof Equipment) {
                        Equipment eq = (Equipment)it; boolean isEquipped = player.equippedRelics.contains(eq) || player.equippedWeapons.contains(eq) || player.equippedArmors.contains(eq);
                ...
                SwingUtilities.invokeLater(() -> { wScroll.getVerticalScrollBar().setValue(scrollWeapon); aScroll.getVerticalScrollBar().setValue(scrollArmor); rScroll.getVerticalScrollBar().setValue(scrollRelic); cScroll.getVerticalScrollBar().setValue(scrollConsumable); });
                ...
                if(lastInventoryTab < tabs.getTabCount()) tabs.setSelectedIndex(lastInventoryTab); dash.add(tabs, BorderLayout.CENTER); content.add(dash);
            } else if(key.equals("STATS")) {
                int[] b = player.getBonusStats(); JPanel mainStatPanel = new JPanel(new BorderLayout(10, 10)); mainStatPanel.setOpaque(false);
                JPanel headerPanel = new JPanel(new GridLayout(1, 2)); headerPanel.setOpaque(false); headerPanel.setBorder(new MatteBorder(0, 0, 2, 0, ACCENT_COL));
                headerPanel.add(createStatLabel("CLASS:", player.cls.title, ACCENT_COL)); headerPanel.add(createStatLabel("LEVEL:", String.valueOf(player.level), TEXT_DARK)); mainStatPanel.add(headerPanel, BorderLayout.NORTH);
                JPanel columns = new JPanel(new GridLayout(1, 3, 15, 0)); columns.setOpaque(false);
                JPanel coreBox = new JPanel(new GridLayout(0, 1, 5, 5)); coreBox.setOpaque(false); coreBox.add(new JLabel("<html><font color='#D4AF37'><b>CORE ATTRIBUTES</b></font></html>"));
                ...
                coreBox.add(createStatLabel("INT:", String.valueOf(player.getTotalInt()), TEXT_DARK)); coreBox.add(createStatLabel("WIS:", String.valueOf(player.getTotalWis()), TEXT_DARK)); coreBox.add(createStatLabel("CHA:", String.valueOf(player.getTotalCha()), TEXT_DARK)); columns.add(coreBox);
                ...
                combatBox.add(createStatLabel("ATK:", player.getTotalAtk() + " (+" + (int)(b[1]*player.getFamiliarMultiplier()) + ")", TEXT_DARK)); combatBox.add(createStatLabel("DEF:", player.getTotalDef() + " (+" + (int)(b[2]*player.getFamiliarMultiplier()) + ")", TEXT_DARK));
                combatBox.add(createStatLabel("AGI:", String.valueOf(player.agi), TEXT_DARK)); combatBox.add(createStatLabel("CRT CHANCE:", player.crt + "%", new Color(200,180,0)));
                double dodge = Math.min(0.60, (player.getTotalSpd()) * 0.012) * 100; combatBox.add(createStatLabel("EVASION:", String.format("%.1f%%", dodge), new Color(0, 180, 180))); combatBox.add(createStatLabel("ACCURACY:", player.acc + "%", TEXT_DARK)); columns.add(combatBox);
                ...
                utilBox.add(createStatLabel("XP:", player.xp + " / " + player.getExpRequirement(), new Color(200, 120, 0))); utilBox.add(createStatLabel("XP TO NEXT:", String.valueOf(player.getExpRequirement() - player.xp), new Color(0, 180, 180)));
                utilBox.add(createStatLabel("LUCK:", player.getTotalLuk() + " (+" + (int)(b[4]*player.getFamiliarMultiplier()) + ")", TEXT_DARK)); utilBox.add(createStatLabel("SPEED:", player.getTotalSpd() + " (+" + (int)(b[3]*player.getFamiliarMultiplier()) + ")", TEXT_DARK));
                utilBox.add(createStatLabel("TIME:", (player.totalRunTicks / 33) + "s", Color.LIGHT_GRAY)); utilBox.add(createStatLabel("REPUTATION:", String.valueOf(player.reputation), new Color(180, 80, 180))); utilBox.add(createStatLabel("ACC RATING:", player.accuracyRating + "%", TEXT_DARK)); columns.add(utilBox);
                mainStatPanel.add(columns, BorderLayout.CENTER); content.add(mainStatPanel);
            } else if(key.equals("LEVEL_UP")) {
                content.removeAll(); content.setLayout(new BorderLayout()); JPanel header = new JPanel(new FlowLayout(FlowLayout.CENTER)); header.setOpaque(false);
                ...
                gq.gridy = 2; StylizedButton submit = new StylizedButton("Submit"); submit.addActionListener(e -> processPrayerAnswer(answerField.getText())); qP.add(submit, gq); content.add(qP);
            }
        ...
        private JPanel createConsumableCard(String text, int count, ActionListener action, Color c) {
            JPanel card = new JPanel(new BorderLayout()); card.setBorder(BorderFactory.createLineBorder(c, 2)); card.setBackground(new Color(25,25,30));
        ...
        private JPanel createItemCard(Equipment eq, boolean isEq, Player p) {
            ...
            JLabel n = new JLabel("<html>" + (isEq?"<b>[E]</b> ":"") + eq.name + "</html>"); n.setForeground(eq.rarity.col); n.setFont(FONT_SANSSERIF_BOLD_12); n.setBorder(new EmptyBorder(5, 5, 0, 5)); n.setToolTipText("<html>" + eq.getStatsString() + "<br>" + (eq.passive!=null ? "<b>" + eq.passive + "</b>" : "") + "</html>");
        ...
        private void addConsumableBtn(JPanel p, String name, Supplier<Integer> countSupplier, ActionListener a) {
            StylizedButton b = new StylizedButton("<html><center>" + name + "<br>(" + countSupplier.get() + ")</center></html>"); b.setPreferredSize(new Dimension(140, 45)); b.setFont(FONT_SANSSERIF_BOLD_12);
            boolean isHeal = name.contains("Potion"); boolean fullHp = state.player.hp >= state.player.getTotalMaxHp();
            if(countSupplier.get() == 0 || (isHeal && fullHp)) b.setForeground(Color.DARK_GRAY);
            b.addActionListener(e -> { if(!inputLocked && countSupplier.get() > 0 && !(isHeal && state.player.hp >= state.player.getTotalMaxHp())) a.actionPerformed(e); }); p.add(b);
        }

        private Familiar generateRandomFamiliar() {
            Random r = new Random(); int roll = r.nextInt(20); String[] names = {"Wisp", "Sprite", "Mini-Slime", "Imp", "Pixie", "Bat", "Fairy", "Wolf", "Panther", "Drake", "Golem", "Gargoyle", "Manticore", "Treant", "Gryphon", "Phoenix", "Behemoth", "Wyrm", "Leviathan", "Chimera"};
            Rarity rarity = roll < 7 ? Rarity.RARE : (roll < 15 ? Rarity.EPIC : Rarity.LEGENDARY); FamiliarSize size = roll < 7 ? FamiliarSize.SMALL : (roll < 15 ? FamiliarSize.MEDIUM : FamiliarSize.LARGE);
        ...
        private void buildSideShop() {
            ...
            header.add(new JLabel("<html><font size='5' color='"+toHex(ACCENT_COL)+"'>MERCHANT</font></html>")); header.add(new JLabel("<html><font size='4' color='white'>Gold: " + p.gold + "G</font></html>"));
            header.add(new JLabel("<html><font color='gray'>Refreshes in: " + encountersUntilRefresh + " battles</font></html>")); header.add(new JLabel("<html><font color='gray'>Mystery Box Pity: " + mysteryBoxPity + "/5</font></html>"));
            sideShopPanel.add(header, BorderLayout.NORTH); JPanel items = new JPanel(); items.setLayout(new BoxLayout(items, BoxLayout.Y_AXIS)); items.setOpaque(false); items.setBorder(new EmptyBorder(10, 10, 10, 10));

            for(Item it : shopStock) {
                StylizedButton btn = new StylizedButton("<html><center>" + it.name + "<br>" + it.price + "G</center></html>"); btn.setPreferredSize(new Dimension(240, 60)); btn.setMaximumSize(new Dimension(240, 60)); btn.setAlignmentX(Component.CENTER_ALIGNMENT);
                ...
                else if(it.name.contains("Elixir")) btn.setForeground(Color.MAGENTA); else if(it.name.contains("Mystery Box")) btn.setForeground(Color.YELLOW); else if(it.name.contains("Familiar Crystal") || it.name.contains("Summon Familiar")) btn.setForeground(Color.CYAN);
                if(p.gold < it.price) btn.setForeground(Color.DARK_GRAY);
                btn.addActionListener(e -> {
                    if(p.gold >= it.price) {
                        p.gold -= it.price;
                        if(it instanceof Equipment) { gainItem((Equipment)it); }
                        else {
                            if(it.name.contains("Greater")) p.greaterPots++; else if(it.name.contains("Damage")) p.dmgBuffs++;
                            else if(it.name.contains("Mystery Box")) { Equipment dropped = generateProceduralEquipment(true); log.append("[GACHA] Box contained: " + dropped.name + " (" + dropped.rarity.name + ")!\n"); gainItem(dropped); }
                                ...
                                if(p.ownedFamiliars.size() < 5) { Familiar newFam = generateRandomFamiliar(); p.ownedFamiliars.add(newFam); if(p.equippedFamiliars.size() < 2) p.equippedFamiliars.add(newFam); log.append("[SYS] Summoned Familiar: " + newFam.name + "!\n"); }
            ...
            if(autoSold) { p.gold += dropped.rarity.sellValue; log.append("[LOOT] AUTO-SOLD " + dropped.name + " for " + dropped.rarity.sellValue + "G\n"); dmgNums.add(new DamageNumber(dropped.rarity.sellValue, 250, 250, Color.YELLOW, "+" + dropped.rarity.sellValue + "G")); }
                ...
                if(autoEquipBest) {
                    if(dropped instanceof Relic) {
                        ...
                        else { Relic worst = p.equippedRelics.stream().min(Comparator.comparingDouble(r -> r.rarity.multiplier)).orElse(null); if(worst != null && dropped.rarity.multiplier > worst.rarity.multiplier) { p.equippedRelics.remove(worst); p.equippedRelics.add((Relic)dropped); log.append("[SYS] Auto-Equipped better Relic!\n"); } }
                    } else if(dropped instanceof Weapon) {
                        if(p.equippedWeapons.size() < 2) p.equippedWeapons.add((Weapon)dropped);
                        else { Weapon worst = p.equippedWeapons.stream().min(Comparator.comparingDouble(w -> w.rarity.multiplier)).orElse(null); if(worst != null && dropped.rarity.multiplier > worst.rarity.multiplier) { p.equippedWeapons.remove(worst); p.equippedWeapons.add((Weapon)dropped); log.append("[SYS] Auto-Equipped better Weapon!\n"); } }
                    } else if(dropped instanceof Armor) {
                        if(p.equippedArmors.size() < 4) p.equippedArmors.add((Armor)dropped);
                        else { Armor worst = p.equippedArmors.stream().min(Comparator.comparingDouble(a -> a.rarity.multiplier)).orElse(null); if(worst != null && dropped.rarity.multiplier > worst.rarity.multiplier) { p.equippedArmors.remove(worst); p.equippedArmors.add((Armor)dropped); log.append("[SYS] Auto-Equipped better Armor!\n"); } }
                    }
                }
            }
        }
        ...
        private void executeAttack(String move) {
            Player p = state.player; boolean isUlt = move.contains("[ULTIMATE]"); int cost = isUlt ? 100 : (move.contains("(15 EN)") ? 15 : move.contains("(20 EN)") ? 20 : move.contains("(30 EN)") ? 30 : move.contains("(35 EN)") ? 35 : move.contains("(40 EN)") ? 40 : 0);
            if(isUlt && p.ultStacks < 12) { log.append("[SYS] Requires 12 Ultimate Stacks!\n"); return; } if(p.energy < cost) { log.append("[SYS] Not enough Energy!\n"); return; }
            inputLocked = true; setMenu("EMPTY"); p.energy -= cost; p.combo++; p.currentAnim = "WINDUP"; p.animTick = 0;
            p.onAnimComplete = () -> {
                if (isUlt) { p.ultStacks -= 12; log.append("[COMBAT] " + p.name + " unleashed their ULTIMATE!\n"); } else { p.ultStacks = Math.min(12, p.ultStacks + 1); }
                boolean isCrit = Math.random() < ((p.getTotalLuk() + p.crt) * 0.015); double comboMult = 1.0 + (p.combo * 0.05); int baseDmg = calculateBaseDamage(move, p);
                ...
                for(Weapon w : p.equippedWeapons) { if("Operator's Precision".equals(w.passive)) baseDmg *= 1.2; if("Sorcerer's Echo".equals(w.passive) && Math.random() < 0.25) { baseDmg *= 2; log.append("[COMBAT] Sorcerer's Echo Double Cast!\n"); } }
                ...
                enemy.takeDamage(reducedDmg); screenShake = isCrit ? 15 : (isUlt ? 30 : 5); spawnImpactEffect(move, enemy.animX + 700, enemy.animY + 250);
                ...
                if(move.contains("[HEAL]") || hasVampirism) { int heal = reducedDmg / (hasVampirism ? 4 : 3); p.heal(heal); dmgNums.add(new DamageNumber(heal, 280, 280, Color.GREEN)); for(int i=0; i<5; i++) particles.add(new Particle(Color.GREEN, true, 250, 250)); log.append("[COMBAT] Lifesteal restored " + heal + " HP!\n"); }
                for(Weapon w : p.equippedWeapons) { if("Soul Syphon".equals(w.passive)) { p.energy = Math.min(p.maxEnergy, p.energy + 15); dmgNums.add(new DamageNumber(15, 280, 260, ENERGY_BLUE, "+15 EN")); break; } }
        ...
        private void spawnImpactEffect(String move, double x, double y) {
            Random r = new Random();
            if(move.contains("[ULTIMATE]")) { for(int i=0; i<100; i++) particles.add(new Particle(state.player.cls.color, true, x, y, (r.nextDouble()-0.5)*18, (r.nextDouble()-0.5)*18, 40+r.nextInt(30), 4+r.nextDouble()*6)); return; }
            if(move.contains("Fireball") || move.contains("Solar Beam") || move.contains("Smite") || move.contains("Explosive")) { for(int i=0; i<30; i++) particles.add(new Particle(Color.ORANGE, true, x, y, (r.nextDouble()-0.5)*8, (r.nextDouble()-0.5)*8 - 2, 30+r.nextInt(20), 3+r.nextDouble()*5)); }
            else if(move.contains("Shield Bash") || move.contains("Aegis") || move.contains("Phalanx")) { for(int i=0; i<25; i++) particles.add(new Particle(Color.LIGHT_GRAY, true, x, y, (r.nextDouble()-0.5)*10, (r.nextDouble()-0.5)*3, 20+r.nextInt(20), 4+r.nextDouble()*4)); }
            else if(move.contains("Toxic") || move.contains("Acid") || move.contains("Poison")) { for(int i=0; i<30; i++) particles.add(new Particle(Color.GREEN, true, x, y, (r.nextDouble()-0.5)*5, r.nextDouble()*5, 40+r.nextInt(20), 3+r.nextDouble()*4)); }
            else if(move.contains("Piercing") || move.contains("Snipe") || move.contains("Arrow") || move.contains("Volley")) { for(int i=0; i<20; i++) particles.add(new Particle(Color.CYAN, true, x, y, -5 - r.nextDouble()*10, (r.nextDouble()-0.5)*2, 20+r.nextInt(15), 2+r.nextDouble()*3)); }
            else if(move.contains("Holy") || move.contains("Divine") || move.contains("Healing")) { for(int i=0; i<35; i++) particles.add(new Particle(Color.YELLOW, true, x, y, (r.nextDouble()-0.5)*6, -3 - r.nextDouble()*6, 30+r.nextInt(20), 3+r.nextDouble()*4)); if(move.contains("[HEAL]")) for(int i=0; i<15; i++) particles.add(new Particle(Color.GREEN, true, x, y, (r.nextDouble()-0.5)*4, -2 - r.nextDouble()*4, 25+r.nextInt(15), 3+r.nextDouble()*3)); }
            else if(move.contains("Void") || move.contains("Curse") || move.contains("Drain") || move.contains("Necro")) { for(int i=0; i<30; i++) particles.add(new Particle(new Color(100, 0, 150), true, x, y, (r.nextDouble()-0.5)*8, (r.nextDouble()-0.5)*8, 40+r.nextInt(20), 3+r.nextDouble()*5)); }
            else if(move.contains("Wind") || move.contains("Slash") || move.contains("Strike") || move.contains("Execution") || move.contains("Backstab")) { for(int i=0; i<25; i++) particles.add(new Particle(Color.WHITE, true, x, y, (r.nextDouble()-0.5)*12, (r.nextDouble()-0.5)*12, 15+r.nextInt(15), 2+r.nextDouble()*3)); }
            else if(move.contains("Chord") || move.contains("Anthem") || move.contains("Crescendo")) { for(int i=0; i<25; i++) particles.add(new Particle(Color.MAGENTA, true, x, y, (r.nextDouble()-0.5)*7, -2 - r.nextDouble()*5, 35+r.nextInt(20), 3+r.nextDouble()*4)); }
            else if(move.contains("Vine") || move.contains("Barkskin")) { for(int i=0; i<25; i++) particles.add(new Particle(new Color(34, 139, 34), true, x, y, (r.nextDouble()-0.5)*6, (r.nextDouble()-0.5)*6, 30+r.nextInt(20), 3+r.nextDouble()*4)); }
            else if(move.contains("Bone") || move.contains("Corpse")) { for(int i=0; i<30; i++) particles.add(new Particle(Color.GRAY, true, x, y, (r.nextDouble()-0.5)*8, (r.nextDouble()-0.5)*8 - 3, 30+r.nextInt(20), 3+r.nextDouble()*4)); }
            else { for(int i=0; i<20; i++) particles.add(new Particle(Color.WHITE, true, x, y, (r.nextDouble()-0.5)*5, (r.nextDouble()-0.5)*5, 20+r.nextInt(15), 2+r.nextDouble()*3)); }
        }

        private void spawnDotEffect(String type, double x, double y) {
            Random r = new Random();
            if(type.equals("BURN")) { for(int i=0; i<15; i++) particles.add(new Particle(Color.ORANGE, true, x, y, (r.nextDouble()-0.5)*4, -2 - r.nextDouble()*3, 20+r.nextInt(15), 3+r.nextDouble()*3)); }
            else if(type.equals("POISON")) { for(int i=0; i<15; i++) particles.add(new Particle(Color.GREEN, true, x, y, (r.nextDouble()-0.5)*3, -1 - r.nextDouble()*2, 25+r.nextInt(15), 3+r.nextDouble()*4)); }
            else if(type.equals("BLEED")) { for(int i=0; i<15; i++) particles.add(new Particle(Color.RED, true, x, y, (r.nextDouble()-0.5)*2, 1 + r.nextDouble()*4, 20+r.nextInt(15), 3+r.nextDouble()*3)); }
        }
        ...
        private int calculateBaseDamage(String m, Player p) {
            ...
            if(m.contains("[ULTIMATE]")) {
                double scale = 0; if(p.cls == ClassType.KNIGHT) scale = p.getTotalDef() + p.getTotalMaxHp() * 0.1; else if(p.cls == ClassType.SORCERER) scale = p.getTotalInt() + p.getTotalLuk();
                else if(p.cls == ClassType.OPERATOR) scale = p.getTotalDex() + p.acc * 0.5; else if(p.cls == ClassType.RANGER) scale = p.agi + p.getTotalLuk();
                else if(p.cls == ClassType.PALADIN) scale = p.getTotalCon() + p.getTotalCha(); else if(p.cls == ClassType.RONIN) scale = p.getTotalDex() + p.crt;
                else if(p.cls == ClassType.BARD) scale = p.getTotalCha() + p.getTotalLuk(); else if(p.cls == ClassType.DRUID) scale = p.getTotalWis() + p.getTotalCon();
                else if(p.cls == ClassType.NECROMANCER) scale = p.getTotalInt() + p.getTotalCon(); else if(p.cls == ClassType.ALCHEMIST) scale = p.getTotalInt() + p.getTotalLuk();
                return (int)(scale * 5.0);
            }
            if(m.contains("Basic") || m.contains("Quick Draw")) return tAtk; if(m.contains("Shield Bash")) return (int)(tDef * 1.8);
            if(m.contains("Aegis Crush")) return (int)(tDef * 2.5 + p.getTotalMaxHp() * 0.1); if(m.contains("Phalanx")) return (int)(tDef * 1.5);
            ...
            if(m.contains("Volley")) return (int)(tSpd * 2.0 + tLuk); if(m.contains("Snipe")) return (int)((tSpd + tAtk) * 2.5);
            if(m.contains("Holy Strike")) return (int)(tAtk * 1.5 + p.getTotalMaxHp() * 0.05); if(m.contains("Divine Favor")) return (int)(tAtk * 1.2 + tDef);
            if(m.contains("Smite")) return (int)(tAtk * 2.0 + tDef * 1.5); if(m.contains("Wind Slash")) return (int)(tAtk * 1.5 + tSpd * 2.0);
            if(m.contains("Dragon Strike")) return (int)(tAtk * 2.5 + tSpd); if(m.contains("Dissonant Chord")) return (int)(tCha * 1.5 + tLuk);
            if(m.contains("Inspiring Anthem")) return (int)(tCha * 2.0); if(m.contains("Crescendo")) return (int)(tCha * 2.5 + tLuk * 1.5);
            if(m.contains("Vine Whip")) return (int)(tWis * 1.5 + tAtk); if(m.contains("Barkskin")) return (int)(tWis * 1.5 + tDef);
            if(m.contains("Solar Beam")) return (int)(tWis * 2.5 + tCon); if(m.contains("Life Drain")) return (int)(tInt * 1.5 + tCon);
            if(m.contains("Bone Spear")) return (int)(tInt * 2.0 + tAtk); if(m.contains("Corpse Explosion")) return (int)(tInt * 2.5 + tCon * 1.5);
            if(m.contains("Acid Flask")) return (int)(tInt * 1.5 + tSpd); if(m.contains("Healing Draught")) return (int)(tInt * 1.5 + tLuk);
            if(m.contains("Explosive Mixture")) return (int)(tInt * 2.5 + tLuk * 1.5); return tAtk;
        }

        private void executeDefend() {
            Player p = state.player; p.combo = 0; int bDef = p.getTotalDef(); p.shield += bDef * 2 + 50;
        ...
        private void executeRest() {
            ...
            p.combo = 0; p.gold -= 10; int interest = (int)(p.gold * 0.05); p.gold += interest; p.energy = Math.min(p.maxEnergy, p.energy + 50); p.heal((int)(p.getTotalMaxHp() * 0.5));
        ...
        private void setupQuestion(int ticks) {
            String[] qa = generatePrayerQuestion(selectedDifficulty); currentQuestion = qa[0]; correctAnswer = qa[1];
            prayerTimerRemaining = ticks; prayerTimerMax = ticks; prayerPhase = "QUESTION"; setMenu("PRAYER_Q");
        }

        private String[] generatePrayerQuestion(int difficulty) {
            Random r = new Random(); int type = r.nextInt(2);
            if(difficulty == 1) {
        ...
        private void processPrayerAnswer(String answer) {
            ...
            if (correct) {
                ...
                switch(rStat) {
                    case 0: p.str++; break; case 1: p.con++; break; case 2: p.dex++; break;
                ...
                if(p.hp <= 0) { log.append("\n[SYS] GAME OVER\n"); prayerActive = false; Timer deathTimer = new Timer(1500, dt -> { gameLoop.stop(); deathScreen.triggerDeath(state.encounters, state.player.level, maxComboAchieved, state.player.gold); cards.show(mainContainer, "DEATH"); }); deathTimer.setRepeats(false); deathTimer.start(); }
            }
            setMenu("EMPTY");
        }

        private void endPlayerTurn() {
            Player p = state.player; if(prayerCooldown > 0) prayerCooldown--;
            if(p.prayerBuffTurns > 0) { p.prayerBuffTurns--; if(p.prayerBuffTurns == 0) p.prayerBuffMult = 1.0; }
            ...
            if(enemy != null && enemy.hp > 0) {
                ...
                for(Familiar f : p.equippedFamiliars) { if (enemy == null || enemy.hp <= 0) break; int famDmg = (f.rarity == Rarity.RARE ? 15 : (f.rarity == Rarity.EPIC ? 30 : 60)) + (p.level * 5); enemy.takeDamage(famDmg); log.append("[PET] " + f.name + " attacks for " + famDmg + " dmg!\n"); dmgNums.add(new DamageNumber(famDmg, 780, 220 + (int)(Math.random()*40), Color.CYAN)); }
        ...
        private void enemyTurn() {
            ...
            if(dotDmg > 0) { enemy.takeDamage(dotDmg); dmgNums.add(new DamageNumber(dotDmg, 780, 250, Color.ORANGE)); log.append("[COMBAT] Enemy takes " + dotDmg + " DOT damage!\n"); if(enemy.hp <= 0) { endEncounter(); return; } }
            ...
            enemy.turnCounter++; double dodgeChance = Math.min(0.60, (p.getTotalSpd()) * 0.012);
            if(Math.random() < dodgeChance) { log.append("[COMBAT] DODGE!\n"); dmgNums.add(new DamageNumber(0, 280, 280, Color.CYAN, "DODGE")); int counterDmg = (p.getTotalSpd()) * 2; enemy.takeDamage(counterDmg); log.append("[COMBAT] Counter-attacked for " + counterDmg + " damage!\n"); dmgNums.add(new DamageNumber(counterDmg, 780, 300, Color.WHITE)); if(enemy.hp <= 0) endEncounter(); else { inputLocked = false; setMenu("MAIN"); } return; }
            ...
            enemy.onAnimComplete = () -> {
                ...
                if(p.hp <= 0) { log.append("\n[SYS] GAME OVER\n"); Timer deathTimer = new Timer(1500, dt -> { gameLoop.stop(); deathScreen.triggerDeath(state.encounters, state.player.level, maxComboAchieved, state.player.gold); cards.show(mainContainer, "DEATH"); }); deathTimer.setRepeats(false); deathTimer.start(); } else { inputLocked = false; setMenu("MAIN"); }
            };
        }

        private void spawnEnemy() {
            enemy = new Enemy("Void Aberration", state.encounters, state.encounters % 5 == 0); log.append("\n[SYS] ENCOUNTER " + state.encounters + "\n");
            if (enemy.isBoss) { String dialogue = "I SHALL END YOU!"; if(enemy.bossArchetype == BossArchetype.COLOSSUS) dialogue = "PUNY MORTAL. YOU SHALL BE CRUSHED!"; else if(enemy.bossArchetype == BossArchetype.NECROMANCER) dialogue = "YOUR SOUL WILL SERVE MY UNDEAD ARMY..."; else if(enemy.bossArchetype == BossArchetype.MECHA_CORE) dialogue = "THREAT DETECTED. EXTERMINATION PROTOCOL INITIATED."; else if(enemy.bossArchetype == BossArchetype.VOID_DRAGON) dialogue = "ROOOOAAARRR!!! THE VOID CONSUMES ALL!"; log.append("[BOSS] " + enemy.name + ": \"" + dialogue + "\"\n"); }
        ...
        private Equipment generateProceduralEquipment(boolean fromMysteryBox) {
            ...
            if(typeRoll == 0) { String pass = rarity == Rarity.GODLY ? GODLY_PASSIVES[rnd.nextInt(GODLY_PASSIVES.length)] : (rarity == Rarity.MYTHIC ? MYTHIC_PASSIVES[rnd.nextInt(MYTHIC_PASSIVES.length)] : null); Relic r = new Relic(rarity.name + " " + RELIC_NAMES[rnd.nextInt(RELIC_NAMES.length)], calcPrice, b*m*5, b*m, b*m, (b/2)*m, (b/2)*m, st, co, de, in, wi, ch, rarity); r.passive = pass; return r; }
            else if(typeRoll == 1) { String name = WEAPON_PREFIXES[rnd.nextInt(WEAPON_PREFIXES.length)] + " " + WEAPON_NOUNS[rnd.nextInt(WEAPON_NOUNS.length)]; String pass = rarity.multiplier >= 3.0 ? WEAPON_PASSIVES[rnd.nextInt(WEAPON_PASSIVES.length)] : null; Weapon w = new Weapon(name, calcPrice, b*m*2, (b*2)*m, (b/3)*m, b*m, b*m, st, co, de, in, wi, ch, rarity); w.passive = pass; return w; }
            else { String name = ARMOR_PREFIXES[rnd.nextInt(ARMOR_PREFIXES.length)] + " " + ARMOR_NOUNS[rnd.nextInt(ARMOR_NOUNS.length)]; String pass = rarity.multiplier >= 5.5 ? "Knight's Resolve" : null; Armor a = new Armor(name, calcPrice, b*m*10, (b/3)*m, (b*2)*m, (b/2)*m, b*m, st, co, de, in, wi, ch, rarity); a.passive = pass; return a; }
        }
        ...
        private void refreshShop() {
            ...
            shopStock.add(new Consumable("Mystery Box", 100, "GACHA")); if(totalShopRefreshes >= 5) { if(state.player.level >= 3 && !state.player.hasPet) shopStock.add(new Consumable("Familiar Crystal", 300, "PET")); shopStock.add(new Consumable("Summon Familiar", 500, "NEW_FAMILIAR")); }
        ...
        private void drawScene(Graphics2D g) {
            ...
            if(enemy != null && enemy.isBoss && enemy.turnCounter % 4 == 3) { g.setColor(new Color(255, 0, 0, 40)); g.fillRect(0, 0, 950, 480); g.setColor(Color.RED); g.setFont(FONT_IMPACT_30_ITALIC); g.drawString("WARNING: DEVASTATING STRIKE", 250, 100); }
            ...
            if(state.player.combo > 1) { int cSize = Math.min(45, 28 + state.player.combo * 2); g.setColor(state.player.combo > 5 ? Color.RED : XP_ORANGE); g.setFont(FONT_IMPACT_30_ITALIC.deriveFont((float)cSize)); g.drawString(state.player.combo + "x COMBO", 20, 130); }
            ...
            if (prayerActive) {
                ...
                // --- Seraphim Custom Visuals ---
                int idleY = godAnimY + (int)(Math.sin(tick * 0.1) * 15);
                int cx = 475, cy = idleY;

                // Seraphim Wings (6 wings total, dynamically flapping)
                g.setColor(new Color(40, 0, 60, 220));
                int flap = (int)(Math.cos(tick * 0.2) * 40);
                ...
                g.fillOval(cx - 10, cy - 25, 20, 10); // Main Center Eye
                g.fillOval(cx - 25, cy - 5, 12, 6);
                g.fillOval(cx + 13, cy - 5, 12, 6);
                g.fillOval(cx - 15, cy + 15, 10, 5);
                g.fillOval(cx + 5, cy + 15, 10, 5);

                // UI & Timer
                g.setColor(Color.WHITE); g.setFont(FONT_SERIF_BOLD_22); FontMetrics fm2 = g.getFontMetrics(); g.drawString(godMessage, cx - fm2.stringWidth(godMessage)/2, cy + 130);
                if (prayerPhase.equals("QUESTION")) {
                    // Visual Timer Halo
                    g.setColor(new Color(255, 0, 0, 150));
                    g.setStroke(BORDER_STROKE_THICK);
                    int arcAngle = (int)(((double)prayerTimerRemaining / prayerTimerMax) * 360);
                    g.drawArc(cx - 70, cy - 70, 140, 140, 90, arcAngle);

                    g.setFont(FONT_IMPACT_28); g.setColor(Color.RED);
                    String tStr = "Time: " + (prayerTimerRemaining/33);
                    g.drawString(tStr, cx - g.getFontMetrics().stringWidth(tStr)/2, cy + 170);
                }
            }
        ...
        private void drawBar(Graphics2D g, int x, int y, String label, double v, int m, Color c, int w, int h) {
            ...
            if(label.equals("ENERGY") && v > 0) { g.setColor(new Color(255, 255, 255, 100)); for(int i=0; i<3; i++) { int px = x + (int)((tick * (2+i)) % (w * Math.max(0, Math.min(1.0, v / m)))); g.fillRect(px, y+2, 2, h-4); } }
            g.setColor(ACCENT_COL); g.drawRoundRect(x, y, w, h, 5, 5);
            String text = label + (m > 0 && !label.equals("SHIELD") ? ": " + (int)v + " / " + m : ": " + (int)v); if(w > 500) text = label;
            ...
            g.setColor(Color.BLACK); g.drawString(text, textX - 1, textY - 1); g.drawString(text, textX + 1, textY - 1); g.drawString(text, textX - 1, textY + 1); g.drawString(text, textX + 1, textY + 1); g.setColor(Color.WHITE); g.drawString(text, textX, textY);
        }
    ...
    class TitleScreen extends JPanel {
        ...
        public TitleScreen() {
            ...
            StylizedButton s = new StylizedButton("ENTER THE RIFT"); s.setPreferredSize(new Dimension(350, 80)); s.setFont(FONT_MONO_BOLD_24); s.addActionListener(e -> cards.show(mainContainer, "TUTORIAL")); add(s, gbc);
            new Timer(30, e -> { tick++; repaint(); }).start();
        }
        protected void paintComponent(Graphics g) {
            super.paintComponent(g); Graphics2D g2 = (Graphics2D)g; g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            Color c1 = new Color(5, 5, 10); Color c2 = new Color(30 + (int)(Math.sin(tick*0.03)*25), 10, 25); g2.setPaint(new GradientPaint(0, 0, c1, 0, getHeight(), c2)); g2.fillRect(0, 0, getWidth(), getHeight()); g2.setColor(new Color(255, 255, 255, 100));
            ...
            g2.setColor(new Color(0, 0, 0, 180)); g2.drawString("VANGUARDS", titleX-8, titleY+8); g2.setColor(ACCENT_COL); g2.drawString("VANGUARDS", titleX, titleY); g2.setClip(new java.awt.geom.Rectangle2D.Double(titleX, titleY - fm.getAscent(), titleWidth, fm.getHeight()));
    ...
    class DeathScreen extends JPanel {
        ...
        public DeathScreen() {
            ...
            StylizedButton restart = new StylizedButton("RESTART JOURNEY"); restart.setPreferredSize(new Dimension(300, 60)); restart.setForeground(Color.RED); restart.addActionListener(e -> { animTimer.stop(); cards.show(mainContainer, "TITLE"); }); add(restart, gbc);
        }
        public void triggerDeath(int encounters, int lvl, int cmbo, int gld) { this.score = encounters; this.level = lvl; this.combo = cmbo; this.gold = gld; this.tick = 0; if(animTimer != null) animTimer.stop(); animTimer = new Timer(30, e -> { tick++; repaint(); }); animTimer.start(); }
        protected void paintComponent(Graphics g) {
            super.paintComponent(g); Graphics2D g2 = (Graphics2D)g; g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            int fade = Math.min(255, tick * 3); g2.setColor(new Color(fade / 3, 0, 0)); g2.fillRect(0, 0, getWidth(), getHeight());
            g2.setColor(new Color(255, 50, 50, fade)); g2.setFont(TITLE_FONT); FontMetrics fm = g2.getFontMetrics(); g2.drawString("YOU DIED", (getWidth() - fm.stringWidth("YOU DIED"))/2, 250);
            if(tick > 60) { g2.setFont(FONT_IMPACT_28); g2.setColor(Color.WHITE); g2.drawString("RUN SUMMARY", 560, 350); g2.setFont(FONT_MONO_BOLD_24); g2.setColor(Color.LIGHT_GRAY); g2.drawString("Encounters Cleared: " + score, 530, 420); g2.drawString("Level Reached: " + level, 530, 470); g2.drawString("Max Combo: " + combo + "x", 530, 520); g2.drawString("Gold Hoarded: " + gold + "G", 530, 570); }
        }
    }
    ...
    class ClassSelect extends JPanel {
        public ClassSelect() {
            ...
            for(ClassType ct : ClassType.values()) {
                ClassButton b = new ClassButton("<html><center><b><font size='4'>" + ct.title + "</font></b><br><br><font size='3' color='gray'>" + ct.scaleDesc + "</font></center></html>", ct); b.setPreferredSize(new Dimension(180, 240));
                b.addActionListener(e -> { String pName = JOptionPane.showInputDialog(this, "Enter your Vanguard's name:", "Vanguard Registration", JOptionPane.PLAIN_MESSAGE); if (pName == null || pName.trim().isEmpty()) { pName = "Hero"; } state.player = new Player(ct); state.player.name = pName; ACCENT_COL = ct.color; introScreen.play(ct, () -> { battlePanel.initSession(); cards.show(mainContainer, "BATTLE"); }); cards.show(mainContainer, "INTRO"); }); grid.add(b);
            }
            add(grid);
        }
    }
    ...
    class ClassButton extends StylizedButton {
        private ClassType classType; public ClassButton(String text, ClassType classType) { super(text); this.classType = classType; }
        @Override protected void paintComponent(Graphics g) {
            ...
            if(classType == ClassType.KNIGHT) { g2.fillRect(cx-15, cy-20, 30, 40); } else if(classType == ClassType.SORCERER) { g2.fillOval(cx-15, cy-15, 30, 30); g2.fillOval(cx-5, cy-25, 10, 10); } else if(classType == ClassType.OPERATOR) { g2.fillPolygon(new int[]{cx, cx+15, cx-15}, new int[]{cy+15, cy-15, cy-15}, 3); } else if(classType == ClassType.RANGER) { g2.drawOval(cx-15, cy-15, 30, 30); g2.drawLine(cx-15, cy+15, cx+15, cy-15); } else if(classType == ClassType.PALADIN) { g2.fillRect(cx-5, cy-25, 10, 40); g2.fillRect(cx-15, cy-10, 30, 10); } else if(classType == ClassType.RONIN) { g2.drawOval(cx-20, cy-5, 40, 10); g2.drawLine(cx-15, cy+5, cx+15, cy-20); } else if(classType == ClassType.BARD) { g2.drawArc(cx-10, cy-15, 15, 15, 180, 180); g2.drawLine(cx-10, cy-7, cx-10, cy+10); g2.fillOval(cx-15, cy+5, 10, 10); } else if(classType == ClassType.DRUID) { g2.fillPolygon(new int[]{cx, cx+10, cx, cx-10}, new int[]{cy-20, cy, cy+20, cy}, 4); } else if(classType == ClassType.NECROMANCER) { g2.fillOval(cx-10, cy-15, 20, 20); g2.fillRect(cx-6, cy, 12, 10); g2.setColor(new Color(15, 15, 20)); g2.fillOval(cx-6, cy-5, 5, 5); g2.fillOval(cx+1, cy-5, 5, 5); } else if(classType == ClassType.ALCHEMIST) { g2.fillPolygon(new int[]{cx, cx+15, cx-15}, new int[]{cy-10, cy+15, cy+15}, 3); g2.fillRect(cx-4, cy-20, 8, 10); }
            g2.dispose();
        }
        @Override protected void paintBorder(Graphics g) { Graphics2D g2 = (Graphics2D) g.create(); g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); g2.setStroke(BORDER_STROKE_THICK); g2.setColor(classType.color); g2.drawRoundRect(2, 2, getWidth() - 5, getHeight() - 5, 20, 20); g2.dispose(); }
    }

    class StylizedButton extends JButton {
        public StylizedButton(String text) {
            super(text); setContentAreaFilled(false); setFocusPainted(false); setBorder(new EmptyBorder(10, 20, 10, 20)); setFont(UI_FONT); setForeground(TEXT_LIGHT); setCursor(new Cursor(Cursor.HAND_CURSOR)); setBackground(new Color(45, 45, 55));
            addMouseListener(new MouseAdapter() { public void mouseEntered(MouseEvent e) { if(getText().startsWith("Prayer") && !getText().contains("CD:")) setBackground(new Color(90, 15, 25)); else setBackground(new Color(70, 70, 85)); repaint(); } public void mouseExited(MouseEvent e) { setBackground(new Color(45, 45, 55)); repaint(); } public void mousePressed(MouseEvent e) { setBackground(ACCENT_COL.darker()); repaint(); } });
        }
        @Override protected void paintComponent(Graphics g) { Graphics2D g2 = (Graphics2D) g.create(); g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); if(getText().startsWith("Prayer") && !getText().contains("CD:")) { g2.setColor(new Color(40, 10, 15)); } else { g2.setColor(getBackground()); } g2.fillRoundRect(0, 0, getWidth(), getHeight(), 10, 10); super.paintComponent(g); g2.dispose(); }
        @Override protected void paintBorder(Graphics g) {
            Graphics2D g2 = (Graphics2D) g.create(); g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            if(getText().startsWith("Prayer")) { if(getText().contains("CD:")) g2.setColor(Color.DARK_GRAY); else { long time = System.currentTimeMillis(); int pulse = (int)((Math.sin(time * 0.005) + 1.0) * 127.5); g2.setColor(new Color(pulse, 0, 0)); g2.setStroke(BORDER_STROKE_THICK); } }
            else if (getText().equals("FAMILIARS")) { if (getForeground() != Color.DARK_GRAY) { long time = System.currentTimeMillis(); int pulseGold = 127 + (int)((Math.sin(time * 0.005) + 1.0) * 63); g2.setColor(new Color(255, 215, 0, pulseGold)); g2.setStroke(BORDER_STROKE_THICK); } else { g2.setColor(Color.DARK_GRAY); g2.setStroke(BORDER_STROKE_THICK); } }
            else if(getForeground().equals(Rarity.GODLY.col) || getForeground().equals(Color.CYAN)) { g2.setStroke(BORDER_STROKE_THICK); long time = System.currentTimeMillis(); int pulseRed = (int)((Math.sin(time * 0.005) + 1.0) * 127.5); g2.setColor(new Color(pulseRed, 255, 200)); }
            else if(getText().contains("SPEED")) { g2.setStroke(BORDER_STROKE_THICK); if (getForeground() == Color.YELLOW) g2.setColor(Color.YELLOW); else g2.setColor(ACCENT_COL); }
