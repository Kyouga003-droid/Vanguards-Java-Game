...
public class Vanguards extends JFrame {
    ...
    class Familiar extends Item {
        ...
        public void render(Graphics2D g, int x, int y, int tick) {
            double scale = size == FamiliarSize.SMALL ?
                    0.8 : (size == FamiliarSize.MEDIUM ? 1.3 : 2.0);
            ...
            switch(id) {
                ...
                case 9: g2.setColor(new Color(200, 50, 50)); g2.fillRoundRect(-10, -8, 20, 16, 5, 5); g2.setColor(Color.ORANGE);
                    g2.fillPolygon(new int[]{0, -10, 10}, new int[]{-8, -15, -15}, 3); break;
                case 10: g2.setColor(new Color(139, 69, 19)); g2.fillRect(-8, -10, 16, 20);
                    g2.setColor(new Color(100, 50, 10)); g2.fillRect(-12, -5, 4, 10); g2.fillRect(8, -5, 4, 10); break;
                case 11: g2.setColor(Color.GRAY);
                    g2.fillPolygon(new int[]{0, 10, -10}, new int[]{-10, 10, 10}, 3); g2.setColor(Color.DARK_GRAY); g2.fillOval(-12, -5, 8, 10); g2.fillOval(4, -5, 8, 10); break;
                case 12: g2.setColor(new Color(210, 180, 140)); g2.fillOval(-10, -6, 20, 12); g2.setColor(Color.RED); g2.fillOval(5, -10, 10, 10); g2.setColor(Color.BLACK);
                    g2.drawArc(-15, -10, 10, 10, 90, 180); break;
                case 13: g2.setColor(new Color(101, 67, 33)); g2.fillRect(-4, -5, 8, 15);
                    g2.setColor(new Color(34, 139, 34)); g2.fillOval(-10, -15, 20, 20); break;
                case 14: g2.setColor(Color.WHITE); g2.fillArc(-12, -8, 16, 16, 90, 180);
                    g2.setColor(new Color(255, 215, 0)); g2.fillArc(-4, -8, 16, 16, -90, 180); g2.setColor(Color.LIGHT_GRAY); g2.fillPolygon(new int[]{0, -10, 10}, new int[]{-8, -15, -15}, 3);
                    break;
                case 15: g2.setColor(Color.RED); g2.fillPolygon(new int[]{0, 15, -15}, new int[]{10, -10, -10}, 3); g2.setColor(Color.ORANGE); g2.fillOval(-6, -6, 12, 12); g2.setColor(Color.YELLOW);
                    g2.drawLine(0, 10, 0, 20); break;
                case 16: g2.setColor(new Color(70, 0, 70)); g2.fillRect(-15, -15, 30, 30); g2.setColor(Color.RED); g2.fillRect(5, -5, 5, 5);
                    g2.fillRect(-10, -5, 5, 5); break;
                case 17: g2.setColor(new Color(0, 150, 100));
                    for(int i=0; i<5; i++) { int wy = (int)(Math.sin(tick*0.2 + i)*5); g2.fillOval(-15 + i*6, wy - 5, 10, 10);
                    } break;
                case 18: g2.setColor(Color.BLUE); g2.fillArc(-15, -10, 30, 20, 0, 180); g2.fillPolygon(new int[]{-15, -25, -25}, new int[]{0, -5, 5}, 3);
                    g2.setColor(Color.CYAN); g2.fillOval(5, -5, 4, 4); break;
                case 19: g2.setColor(new Color(210, 180, 140)); g2.fillOval(-12, -8, 24, 16); g2.setColor(Color.RED);
                    g2.fillOval(4, -12, 8, 8); g2.setColor(Color.GRAY); g2.fillOval(-4, -14, 8, 8); g2.setColor(Color.GREEN); g2.fillOval(-12, -10, 8, 8); break;
            }
            g2.dispose();
        }
    }
    ...
    class Player extends Entity {
        ...
        public String getRankTitle() {
            ...
            if(level < 20) return "Master"; if(level < 25) return "Grandmaster";
            return "Vanguard";
        }
        ...
        public void render(Graphics2D g, int x, int y, int tick) {
            ...
            g.fillOval(px-15, y+85, 90, 20); g.setColor(hitFlash > 0 ? Color.WHITE : color);
            if(shield > 0) { g.setColor(new Color(100, 200, 255, 100));
                g.fillOval(px-20, py-10, 100, 110); g.setColor(hitFlash > 0 ? Color.WHITE : color);
            }

            if(cls == ClassType.KNIGHT) {
                g.setColor(Color.LIGHT_GRAY);
                g.fillRoundRect(px-10, py+10, 30, 80, 5, 5); g.setColor(hitFlash > 0 ? Color.WHITE : color); g.fillRoundRect(px, py, 60, 85, 15, 15);
                ...
                g.setColor(new Color(0, 255, 255)); g.fillOval(px+58, py-25, 20, 20); g.fillOval(px+10, py-30, 15, 15);
                ...
                g.setColor(Color.BLUE); g.fillRect(px-10, py+40, 15, 20); g.setColor(Color.WHITE);
                g.drawLine(px-5, py+45, px+2, py+45);
            } else if(cls == ClassType.RANGER) {
                g.setColor(new Color(20, 50, 20));
                g.fillPolygon(new int[]{px-10, px+30, px+70}, new int[]{py+90, py+10, py+90}, 3); g.setColor(hitFlash > 0 ? Color.WHITE : color);
                ...
                g.setColor(Color.LIGHT_GRAY);
                g.drawLine(px+10, py+40, px+30, py+40); g.setColor(Color.BLACK); g.fillOval(px+15, py+15, 10, 10);
            } else if(cls == ClassType.PALADIN) {
                g.setColor(new Color(255, 215, 0, 100));
                g.fillOval(px-10, py-10, 70, 70); g.setColor(hitFlash > 0 ? Color.WHITE : color); g.fillRect(px, py, 50, 85); g.setColor(Color.YELLOW); g.fillRect(px+20, py+10, 10, 50);
                ...
                g.setColor(Color.DARK_GRAY); g.fillOval(px-5, py, 60, 20); g.setColor(Color.LIGHT_GRAY); g.fillRect(px+45, py+40, 40, 5); g.setColor(Color.LIGHT_GRAY); g.drawLine(px+65, py+42, px+95, py+42);
                ...
                g.setColor(new Color(139, 69, 19)); g.fillOval(px+5, py+35, 30, 40); g.fillRect(px+15, py+15, 10, 30); g.setColor(Color.MAGENTA);
                ...
                g.setColor(new Color(101, 67, 33)); g.drawLine(px+10, py+5, px-5, py-15); g.drawLine(px-5, py-15, px-15, py-10); g.drawLine(px+35, py+5, px+50, py-15); g.drawLine(px+50, py-15, px+60, py-10);
                ...
                g.setColor(Color.WHITE); g.fillOval(px+10, py-10, 20, 25); g.setColor(Color.BLACK); g.fillOval(px+13, py-3, 5, 5); g.fillOval(px+22, py-3, 5, 5); g.setColor(Color.GRAY);
                ...
                g.setColor(Color.CYAN); g.fillOval(px+5, py, 15, 15); g.fillOval(px+25, py, 15, 15); g.setColor(Color.BLACK); g.drawLine(px+20, py+7, px+25, py+7); g.setColor(Color.GREEN);
                ...
                g.setColor(Color.CYAN); g.fillRect(px+15, py+20, 30, 8); g.setColor(Color.DARK_GRAY); g.fillArc(px+5, py-5, 50, 45, 0, 180); g.setColor(Color.GREEN); g.fillOval(px+15, py+15, 12, 12);
                g.fillOval(px+30, py+15, 12, 12); g.setColor(new Color(100, 80, 50)); g.fillRoundRect(px-10, py+20, 15, 40, 5, 5); g.setColor(Color.DARK_GRAY); g.fillRect(px+45, py+30, 40, 10);
            ...
            g.setColor(Color.LIGHT_GRAY); String rank = "<" + getRankTitle() + ">";
            ...
            if(prayerBuffTurns > 0) { g.setColor(new Color(220, 20, 60));
                g.drawString("BLESSING (" + prayerBuffTurns + ")", px, textY); textY -= 15;
            }
            if(thornsTurns > 0) { g.setColor(Color.PINK);
                g.drawString("THORNS (" + thornsTurns + ")", px, textY); textY -= 15;
            }
            if(combo > 1) { g.setColor(new Color(255, 150, 255));
                g.drawString("COMBO x" + combo, px, textY); textY -= 15; }
        }
    }
    ...
    class Enemy extends Entity {
        ...
        public void render(Graphics2D g, int x, int y, int tick) {
            ...
            if (isBoss) {
                if(bossArchetype == BossArchetype.COLOSSUS) { g.fillRect(px, py, 140, 140);
                    g.setColor(Color.RED); g.fillOval(px+40, py+40, 20, 20); g.fillOval(px+80, py+40, 20, 20); }
                else if(bossArchetype == BossArchetype.NECROMANCER) { g.fillPolygon(new int[]{px+70, px+140, px}, new int[]{py-40, py+140, py+140}, 3);
                    g.setColor(Color.MAGENTA); g.fillOval(px-20, py+(int)(Math.sin(tick*0.1)*10), 30, 30); g.fillOval(px+130, py+(int)(Math.cos(tick*0.1)*10), 30, 30); }
                else if(bossArchetype == BossArchetype.MECHA_CORE) { g.fillOval(px+10, py+10, 120, 120);
                    g.setColor(Color.CYAN); g.drawArc(px-10, py-10, 160, 160, tick*5, 180); g.drawArc(px, py, 140, 140, -tick*5, 180); g.fillOval(px+50, py+50, 40, 40);
                }
                else if(bossArchetype == BossArchetype.VOID_DRAGON) { int[] dx = {px+10, px+70, px+130, px+150, px+90, px-20};
                    int[] dy = {py+40, py-20, py+60, py+140, py+100, py+120}; g.fillPolygon(dx, dy, 6); g.setColor(Color.YELLOW); g.fillOval(px+50, py+10, 15, 15);
                }
            } else {
                ...
                g.fillOval(px+20, py+20, 30, 30); g.setColor(Color.RED); g.fillOval(px+30, py+30, 10, 10);
            }
    ...
    class Particle {
        ...
        public Particle(Color c, boolean temp, double startX, double startY, double vx, double vy, int life, double size) {
            this.c = c;
            this.temporary = temp; this.x = startX; this.y = startY; this.speedX = vx; this.speedY = vy; this.life = life;
            this.size = size;
        }
        ...
        public void draw(Graphics2D g) {
            ...
            g.setColor(new Color(c.getRed(), c.getGreen(), c.getBlue(), alpha)); g.fillOval((int)x, (int)y, (int)size, (int)size);
        }
    }
    ...
    public Particle spawnParticle(Color c, boolean temp, double startX, double startY, double vx, double vy, int life, double size) {
        if (!particlePool.isEmpty()) {
            ...
            p.reset(c, temp, startX, startY, vx, vy, life, size);
            return p;
        }
    ...
    class BossWarningScreen extends JPanel {
        ...
        @Override protected void paintComponent(Graphics g) {
            ...
            g2.fillRect(0, 0, getWidth(), getHeight());
            if(tick % 10 < 5) { g2.setColor(Color.RED); g2.setFont(FONT_IMPACT_30_ITALIC.deriveFont(100f)); FontMetrics fm = g2.getFontMetrics();
    ...
    class BattlePanel extends JPanel {
        ...
        public BattlePanel() {
            ...
            gameLoop = new Timer(30, e -> {
                ...
                while(it.hasNext()) {
                    ...
                    if(p.update()) {
                        it.remove();
                        if (particlePool.size() < 500) particlePool.add(p);
                    }
                }
        ...
        private JPanel createFamiliarCard(Familiar f, Player p) {
            ...
            int boost = f.rarity == Rarity.RARE ?
                    10 : (f.rarity == Rarity.EPIC ? 20 : 30);
        ...
        private void refreshSubMenu(String key) {
            ...
            if(key.equals("ATTACKS")) {
                ...
                SwingUtilities.invokeLater(() -> {
                    wScroll.getVerticalScrollBar().setValue(scrollWeapon);
                    aScroll.getVerticalScrollBar().setValue(scrollArmor);
                    rScroll.getVerticalScrollBar().setValue(scrollRelic);
                    cScroll.getVerticalScrollBar().setValue(scrollConsumable);

                    wScroll.getVerticalScrollBar().addAdjustmentListener(e -> scrollWeapon = e.getValue());
                    aScroll.getVerticalScrollBar().addAdjustmentListener(e -> scrollArmor = e.getValue());
                    rScroll.getVerticalScrollBar().addAdjustmentListener(e -> scrollRelic = e.getValue());
                    cScroll.getVerticalScrollBar().addAdjustmentListener(e -> scrollConsumable = e.getValue());
                });
        ...
        private void addConsumableBtn(JPanel p, String name, Supplier<Integer> countSupplier, ActionListener a) {
            ...
            if (isHeal) {
                int maxHeal = name.contains("Minor") ?
                        150 : 350;
                int missingHp = state.player.getTotalMaxHp() - state.player.hp;
        ...
        private void buildSideShop() {
            ...
            header.add(pityLabel);
            sideShopPanel.add(header, BorderLayout.NORTH); JPanel items = new JPanel();
            ...
            for(Item it : shopStock) {
                ...
                if(it instanceof Equipment) { btn.setForeground(((Equipment)it).rarity.col);
                    ...
                    btn.setToolTipText("Pity Tracker: " + mysteryBoxPity + "/5");
            ...
            batchSellPan.setOpaque(false);
            batchSellPan.setMaximumSize(new Dimension(240, 40));

            StylizedButton sellCom = new StylizedButton("Sell All Common");
            sellCom.setFont(FONT_SANSSERIF_PLAIN_10); sellCom.setForeground(Color.LIGHT_GRAY);
            ...
            batchSellPan.add(sellCom); batchSellPan.add(sellRare);
            items.add(batchSellPan);
            items.add(Box.createRigidArea(new Dimension(0, 10)));
        ...
        private boolean isEquipped(Equipment eq) {
            return state.player.equippedWeapons.contains(eq) ||
                    state.player.equippedArmors.contains(eq) || state.player.equippedRelics.contains(eq);
        }
        ...
        private double calculateSmartEqScore(Equipment eq, ClassType ct) {
            ...
            else if(ct == ClassType.BARD) score += eq.cha*2.5 + eq.luk*1.5;
            else if(ct == ClassType.DRUID) score += eq.wis*2.0 + eq.con*1.5;
            else if(ct == ClassType.NECROMANCER) score += eq.intelligence*2.0 + eq.con*1.5;
            else if(ct == ClassType.ALCHEMIST) score += eq.intelligence*1.5 + eq.luk*2.0;
            return score;
        }
        ...
        private void executeAttack(String move) {
            ...
            p.onAnimComplete = () -> {
                if (isUlt) {
                    ...
                    inUltCutscene = true;
                    ultCutsceneTick = 0;
                    activeUltName = moveNameDisplay;
                    pendingUltDamage = processDamage;
                    pendingUltPlayer = p;
                } else {
        ...
        private void startPrayer() {
            inputLocked = true;
            prayerActive = true; prayerPhase = "DESCEND"; godAnimY = -150; godMessage = "Answer my prayers for a blessing"; setMenu("EMPTY");
        }
        ...
        private void processPrayerAnswer(String answer) {
            ...
            if (correct) {
                ...
                switch(rStat) {
                    case 0: p.str++;
                        break; case 1: p.con++; break; case 2: p.dex++; break;
                    case 3: p.intelligence++; break; case 4: p.wis++; break; case 5: p.cha++;
                        break;
                }
        ...
        private void enemyTurn() {
            ...
            if(dotDmg > 0) { enemy.takeDamage(dotDmg);
                Color dotColor = enemy.burnTurns >= enemy.poisonTurns && enemy.burnTurns >= enemy.bleedTurns ?
                        Color.ORANGE :
                        (enemy.poisonTurns >= enemy.bleedTurns ? Color.GREEN : Color.RED);
        ...
        private void drawScene(Graphics2D g) {
            ...
            if (inUltCutscene && pendingUltPlayer != null) {
                ...
                g.drawString(activeUltName.toUpperCase() + "!!!", textX, 240);
            ...
            if (prayerActive) {
                ...
                g.setFont(FONT_SERIF_BOLD_22); FontMetrics fm2 = g.getFontMetrics(); g.drawString(godMessage, cx - fm2.stringWidth(godMessage)/2, cy + 130);
        ...
        private void drawBar(Graphics2D g, int x, int y, String label, double v, int m, Color c, int w, int h) {
            ...
            // Overlord Boss Warning Flash
            if (label.equals("OVERLORD") && (v / m) < 0.3 && (tick % 10 < 5)) {
                g.setColor(Color.WHITE);
            } else if (label.equals("ULTIMATE") && v >= 12 && (tick % 10 < 5)) {
                g.setColor(Color.WHITE);
                // Ultimate Ready Flash
            } else {
                g.setColor(c);
            }

            g.fillRoundRect(x, y, (int)(w * Math.max(0, Math.min(1.0, v / m))), h, 5, 5);
            ...
            if (label.equals("ULTIMATE") && v >= 12) {
                g.setColor(tick % 10 < 5 ? Color.WHITE : ULT_MAGENTA);
            } else {
            ...
            g.drawString(text, textX + 1, textY + 1); g.setColor(Color.WHITE); g.drawString(text, textX, textY);
        }
    ...
    class TitleScreen extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            Color c2 = new Color(30 + (int)(Math.sin(tick*0.03)*25), 10, 25); g2.setPaint(new GradientPaint(0, 0, c1, 0, getHeight(), c2)); g2.fillRect(0, 0, getWidth(), getHeight());
            ...
            g2.setColor(new Color(200, 200, 200, pulseAlpha)); int subWidth = g2.getFontMetrics().stringWidth("World's Greatest Heroes"); g2.drawString("World's Greatest Heroes", (getWidth()-subWidth)/2, 360 + floatY);
        }
    }
    ...
    class ClassButton extends StylizedButton {
        ...
        @Override protected void paintComponent(Graphics g) {
            ...
            if(isHovered) {
                g2.setColor(new Color(classType.color.getRed(), classType.color.getGreen(), classType.color.getBlue(), 150));
                for(int i=0; i<3; i++) {
                    int pX = cx + (int)(Math.sin(hoverTick * 0.1 + i*2) * 30);
                    int pY = cy + (int)(Math.cos(hoverTick * 0.1 + i*2) * 30);
        ...
        @Override protected void paintBorder(Graphics g) { Graphics2D g2 = (Graphics2D) g.create();
            ...
            if (isHovered) {
                g2.setColor(classType.color.brighter());
                g2.drawRoundRect(2, 2, getWidth() - 5, getHeight() - 5, 20, 20);
                g2.setColor(new Color(classType.color.getRed(), classType.color.getGreen(), classType.color.getBlue(), 50));
                g2.fillRect(0, 0, getWidth(), getHeight());
            } else {
    ...
    class StylizedButton extends JButton {
        ...
        @Override protected void paintComponent(Graphics g) { Graphics2D g2 = (Graphics2D) g.create();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); if(getText().startsWith("Prayer") && !getText().contains("CD:")) { g2.setColor(new Color(40, 10, 15)); } else { g2.setColor(getBackground());
            } g2.fillRoundRect(0, 0, getWidth(), getHeight(), 10, 10); super.paintComponent(g); g2.dispose(); }
